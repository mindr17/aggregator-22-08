...
// src/news/rssScraper.ts
var require_rssScraper = __commonJS({
  "src/news/rssScraper.ts"(exports, module) {
    "use strict";
    var Parser2 = require_rss_parser();
...
// src/prices/tradingViewScraper.ts
var require_tradingViewScraper = __commonJS({
  "src/prices/tradingViewScraper.ts"(exports, module) {
    "use strict";
    var { connect, getCandles } = __require("tradingview-ws");
    var { Client: Client2 } = require_lib4();
    var saveInDb = async (data) => {
      const client = new Client2({
        user: "postgres",
        database: "aggregator",
        password: "postgres",
...
var { Client } = require_lib4();
var rssScraper = require_rssScraper();
var tradingViewScraper = require_tradingViewScraper();
var fs = __require("fs");
var path = __require("node:path");
var config = JSON.parse(
  fs.readFileSync(path.resolve(__dirname, "../config.json"))
);
var setVariable = async (name, value) => {
...
var scrapNews = async () => {
  ...
  if (!isActive) {
    ...
    Object.entries(config.rss).forEach(async (x) => {
      try {
  ...
  if (!isActive) {
    ...
    try {
      const tickers = Array.from(
        new Set(Object.entries(config.rss).map((x) => x[1].ticker))
      );
